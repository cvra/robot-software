...
void servo_init(void)
{
    ...
    pwm_start(STM32_TIM1, 0b0110, STM32_PCLK2, SERVO_PWM_TIMER_FREQ, SERVO_PWM_PERIOD);

    /* Timer16 channel 1 */
    rccResetAPB2(RCC_APB2RSTR_TIM16RST);
    rccEnableAPB2(RCC_APB2ENR_TIM16EN, false);
    pwm_start(STM32_TIM16, 1, STM32_PCLK2, SERVO_PWM_TIMER_FREQ, SERVO_PWM_PERIOD);

    /* Timer17 channel 1 */
    rccResetAPB2(RCC_APB2RSTR_TIM17RST);
    rccEnableAPB2(RCC_APB2ENR_TIM17EN, false);
    pwm_start(STM32_TIM17, 1, STM32_PCLK2, SERVO_PWM_TIMER_FREQ, SERVO_PWM_PERIOD);
}
