...
def main():
    ...
    parser.add_argument(
        "--name", required=True, help="symbol name of the MessagePack buffer"
    )
    parser.add_argument(
        "config_file", type=argparse.FileType(), help="YAML file containing the config"
    )
    parser.add_argument(
        "output",
