...
def argparser(parser=None):
    ...
    parser.add_argument(
        "--linear_x", help="Velocity in x direction [m/s]", type=float, default=0
    )
    parser.add_argument(
        "--angular_z", help="Twist in yaw axis [m/s]", type=float, default=0
    )
...
def main(args):
    ...
    def publish_velocity_cmd():
        publish(
            uavcan.thirdparty.cvra.drive.VelocityCommand(
