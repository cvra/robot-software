    ...
    class Handler(socketserver.BaseRequestHandler):
        def handle(self):
            ...
            with data_lock:
                ...
                l1, l2, l3, angles = fwd_kinematics(
                    origin, links, msg.measured.q1, msg.measured.q2, msg.measured.q3
                )
                i1, i2, i3, inputs = fwd_kinematics(
                    origin, links, msg.input.q1, msg.input.q2, msg.input.q3
                )
