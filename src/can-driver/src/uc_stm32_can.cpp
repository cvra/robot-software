...
int CanDriver::init(uavcan::uint32_t bitrate)
{
    ...
    {
        CriticalSectionLocker lock;
        nvicEnableVector(STM32_CAN1_TX_NUMBER,  CORTEX_MAX_KERNEL_PRIORITY);
        nvicEnableVector(STM32_CAN1_RX0_NUMBER, CORTEX_MAX_KERNEL_PRIORITY);
        nvicEnableVector(STM32_CAN1_RX1_NUMBER, CORTEX_MAX_KERNEL_PRIORITY);
#if UAVCAN_STM32_NUM_IFACES > 1
        nvicEnableVector(STM32_CAN2_TX_NUMBER,  CORTEX_MAX_KERNEL_PRIORITY);
        nvicEnableVector(STM32_CAN2_RX0_NUMBER, CORTEX_MAX_KERNEL_PRIORITY);
        nvicEnableVector(STM32_CAN2_RX1_NUMBER, CORTEX_MAX_KERNEL_PRIORITY);
#endif
    }
