...
#define GPIOB_PIN5                  5
#define GPIOB_PIN6_ENCODER_LEFT_CHA 6
#define GPIOB_PIN7_ENCODER_LEFT_CHB 7
...
#define GPIOC_PIN6_ENCODER_RIGHT_CHA 6
#define GPIOC_PIN7_ENCODER_RIGHT_CHB 7
...
#define GPIOE_STARTER               0
#define GPIOE_PIN1                  1
#define GPIOE_PIN2                  2
#define GPIOE_PIN3                  3
#define GPIOE_PIN4_ENCODER_LEFT_CHI 4
#define GPIOE_PIN5                  5
#define GPIOE_PIN6                  6
#define GPIOE_PIN7                  7
#define GPIOE_PIN8                  8
...
#define GPIOG_PIN15_ENCODER_RIGHT_CHI 15
...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_USB_FS_BUSON) |  \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOB_PIN6_ENCODER_LEFT_CHA) |           \
                                     PIN_MODE_ALTERNATE(GPIOB_PIN7_ENCODER_LEFT_CHB) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_USB_FS_BUSON) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN6_ENCODER_LEFT_CHA) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN7_ENCODER_LEFT_CHB) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_100M(GPIOB_USB_FS_BUSON) |  \
                                     ...
                                     PIN_OSPEED_100M(GPIOB_PIN6_ENCODER_LEFT_CHA) |          \
                                     PIN_OSPEED_100M(GPIOB_PIN7_ENCODER_LEFT_CHB) |          \
...
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_USB_FS_BUSON) |      \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_PIN6_ENCODER_LEFT_CHA) |             \
                                     PIN_ODR_HIGH(GPIOB_PIN7_ENCODER_LEFT_CHB) |             \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_USB_FS_BUSON, 0) |   \
                                     ...
                                     PIN_AFIO_AF(GPIOB_PIN6_ENCODER_LEFT_CHA, 2) |           \
                                     PIN_AFIO_AF(GPIOB_PIN7_ENCODER_LEFT_CHB, 2))
...
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_PIN0) |           \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOC_PIN6_ENCODER_RIGHT_CHA) |  \
                                     PIN_MODE_ALTERNATE(GPIOC_PIN7_ENCODER_RIGHT_CHB) |  \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN6_ENCODER_RIGHT_CHA) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN7_ENCODER_RIGHT_CHB) |  \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_100M(GPIOC_PIN0) |          \
                                     ...
                                     PIN_OSPEED_100M(GPIOC_PIN6_ENCODER_RIGHT_CHA) |     \
                                     PIN_OSPEED_100M(GPIOC_PIN7_ENCODER_RIGHT_CHB) |     \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOC_PIN6_ENCODER_RIGHT_CHA) |        \
                                     PIN_ODR_HIGH(GPIOC_PIN7_ENCODER_RIGHT_CHB) |        \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_PIN0, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOC_PIN6_ENCODER_RIGHT_CHA, 2) |      \
                                     PIN_AFIO_AF(GPIOC_PIN7_ENCODER_RIGHT_CHB, 2))
 ...
 */
#define VAL_GPIOE_MODER             (PIN_MODE_INPUT(GPIOE_STARTER) |           \
                                     PIN_MODE_INPUT(GPIOE_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOE_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOE_PIN3) |           \
                                     PIN_MODE_INPUT(GPIOE_PIN4_ENCODER_LEFT_CHI) |           \
...
#define VAL_GPIOE_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOE_STARTER) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_PIN1) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_PIN3) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOE_PIN4_ENCODER_LEFT_CHI) |       \
...
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_100M(GPIOE_STARTER) |          \
                                     PIN_OSPEED_100M(GPIOE_PIN1) |          \
                                     PIN_OSPEED_100M(GPIOE_PIN2) |          \
                                     PIN_OSPEED_100M(GPIOE_PIN3) |          \
                                     PIN_OSPEED_100M(GPIOE_PIN4_ENCODER_LEFT_CHI) |          \
...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_PULLUP(GPIOE_STARTER) |         \
                                     PIN_PUPDR_PULLUP(GPIOE_PIN1) |         \
                                     PIN_PUPDR_PULLUP(GPIOE_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOE_PIN3) |         \
                                     PIN_PUPDR_PULLUP(GPIOE_PIN4_ENCODER_LEFT_CHI) |         \
...
#define VAL_GPIOE_ODR               (PIN_ODR_HIGH(GPIOE_STARTER) |             \
                                     PIN_ODR_HIGH(GPIOE_PIN1) |             \
                                     PIN_ODR_HIGH(GPIOE_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOE_PIN3) |             \
                                     PIN_ODR_HIGH(GPIOE_PIN4_ENCODER_LEFT_CHI) |             \
...
#define VAL_GPIOE_AFRL              (PIN_AFIO_AF(GPIOE_STARTER, 0) |           \
                                     PIN_AFIO_AF(GPIOE_PIN1, 0) |           \
                                     PIN_AFIO_AF(GPIOE_PIN2, 0) |           \
                                     PIN_AFIO_AF(GPIOE_PIN3, 0) |           \
                                     PIN_AFIO_AF(GPIOE_PIN4_ENCODER_LEFT_CHI, 0) |           \
...
#define VAL_GPIOG_MODER             (PIN_MODE_INPUT(GPIOG_PIN0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOG_PIN15_ENCODER_RIGHT_CHI))
#define VAL_GPIOG_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOG_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOG_PIN15_ENCODER_RIGHT_CHI))
#define VAL_GPIOG_OSPEEDR           (PIN_OSPEED_100M(GPIOG_PIN0) |          \
                                     ...
                                     PIN_OSPEED_100M(GPIOG_PIN15_ENCODER_RIGHT_CHI))
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_PULLUP(GPIOG_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOG_PIN15_ENCODER_RIGHT_CHI))
#define VAL_GPIOG_ODR               (PIN_ODR_HIGH(GPIOG_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOG_PIN15_ENCODER_RIGHT_CHI))
...
#define VAL_GPIOG_AFRH              (PIN_AFIO_AF(GPIOG_PIN8, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOG_PIN15_ENCODER_RIGHT_CHI, 0))
