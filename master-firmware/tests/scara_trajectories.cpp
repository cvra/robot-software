...
TEST(ArmTrajectoriesBuilderTest, DateIsCorrectlyComputed)
{
    ...
    scara_trajectory_append_point(&traj, 10, 10, 10, 0, COORDINATE_ARM, 15., arbitraryLengths);
...
TEST(ArmTrajectoriesBuilderTest, WaypointInterpolation)
{
    ...
    scara_trajectory_append_point_with_length(&traj, 0, 0, 0, 0, COORDINATE_ARM, 1., 100, 100, 100);
    scara_trajectory_append_point_with_length(&traj, 10, 20, 30, 40, COORDINATE_ARM, 10., 200, 200, 200);
